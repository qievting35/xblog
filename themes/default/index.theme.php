  ...
  <a name="head"></a>
	...
	<div id="area_artlist">
	  ...
	  <div class="article hasImg">
		<p class="article-pic">
		  <a href="http://sunyongjie.baijia.baidu.com/article/250424" target="_blank" mon="col=13&amp;pn=4&amp;a=12">
			<img src="./upload/a1.jpg" />
		  </a>
		</p>
		<h3>
		  <a href="http://sunyongjie.baijia.baidu.com/article/250424" target="_blank" mon="col=13&amp;pn=4">
			效率与模式：走出以研发支出占比衡量苹果创新的误区
		  </a>
		</h3>
		<p class="article-text1">
		  曾几何时，诸多企业均喜欢以企业研发投入占其营收比重衡量某些企业在所属产业中是最具创新力的。以此衡量，苹果肯定不是最具创新力，但在几乎所有与创...
		</p>
		
		<div class="article-info">
		  作者：<a href="http://sunyongjie.baijia.baidu.com/" class="article-author" target="_blank">孙永杰</a>
		  发表于：<span class="tm">08:00</span>
		  ...
		  <p class="labels">
			<span class="label"><a class="labelnm" href="http://baijia.baidu.com/?tn=listarticle&amp;labelid=10255" target="_blank">苹果</a></span>
			<span class="label"><a class="labelnm" href="http://baijia.baidu.com/?tn=listarticle&amp;labelid=11863" target="_blank">创新</a></span>
			<span class="label"><a class="labelnm" href="http://baijia.baidu.com/?tn=listarticle&amp;labelid=72423" target="_blank">研发投入</a></span>
		  </p>
		</div>
	  </div>
